...
public class PC_AL_06_ProfilesConfiguration_Alarms_ConfigureProfile_ModeProxy extends SuperHelper implements PropertiesProfilesList,PropertiesAlarms {
	...
	@Test (priority = 0)
	public void profilesConfigureProfileModeProxyForAlarms() throws InterruptedException {
		
		//Configure Alarms for Profile of Mode Branch SBC
		classMethodLogger.log(); 
		selectFromDropDown(SLC_SELECTPROFILE, "Pr01ProxyAlarms");
		al.configureProfileForAlarms();
	    setMethodState();
	}
	
	@Test (priority = 1)
	public void profilesAssignProfileModeProxyForAlarms() throws InterruptedException {
		
		//Assign the profile to the OpenBranch
		methodLogger.log(); 
		pr.assignProfile("Pr01ProxyAlarms");
		setMethodState();   
	}
	
	@Test(priority = 2)
	 public void verifyProfileModeProxyForAlarmsAssignment() throws InterruptedException {
