...
public class PC_AL_08_ProfilesConfiguration_Alarms_ConfigureProfile_ModeProxyACD extends SuperHelper implements PropertiesProfilesList,PropertiesAlarms {
	...
	@Test (priority = 0)
	public void profilesConfigureProfileModeProxyACDForAlarms() throws InterruptedException {
		
		//Configure Alarms for Profile of Mode Branch SBC
		classMethodLogger.log(); 
		selectFromDropDown(SLC_SELECTPROFILE, "Pr01ProxyACDAlarms");
		al.configureProfileForAlarms();
	    setMethodState();
	}
	
	@Test (priority = 1)
	public void profilesAssignProfileModeProxyACDForAlarms() throws InterruptedException {
		
		//Assign the profile to the OpenBranch
		methodLogger.log(); 
		pr.assignProfile("Pr01ProxyACDAlarms");
		setMethodState();   
	}
	
	@Test(priority = 2)
	 public void verifyProfileModeProxyACDForAlarmsAssignment() throws InterruptedException {
