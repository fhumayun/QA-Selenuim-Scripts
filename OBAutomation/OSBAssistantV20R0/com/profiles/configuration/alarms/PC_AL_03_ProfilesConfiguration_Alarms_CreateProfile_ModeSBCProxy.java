...
public class PC_AL_03_ProfilesConfiguration_Alarms_CreateProfile_ModeSBCProxy extends SuperHelper implements PropertiesProfilesList {
	...
	@Test (priority = 0)
	public void profilesListCreateProfileModeSBCProxyForAlarms() throws InterruptedException {
		
		classMethodLogger.log(); 
		selectFromDropDown(SLC_ITEMS_PER_PAGE, "50");
		pr.createProfile("Pr01SBCProxyAlarms", TXT_SBC_PROXY, OpenBranchVersion);
		setMethodState();
	}
