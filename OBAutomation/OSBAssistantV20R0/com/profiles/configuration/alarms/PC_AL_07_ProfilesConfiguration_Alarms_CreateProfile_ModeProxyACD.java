...
public class PC_AL_07_ProfilesConfiguration_Alarms_CreateProfile_ModeProxyACD extends SuperHelper implements PropertiesProfilesList {
	...
	@Test (priority = 0)
	public void profilesListCreateProfileModeProxyACDForAlarms() throws InterruptedException {
		
		classMethodLogger.log(); 
		selectFromDropDown(SLC_ITEMS_PER_PAGE, "50");
		pr.createProfile("Pr01ProxyACDAlarms", TXT_PROXY_ACD, OpenBranchVersion);
		setMethodState();
	}
