...
public class PC_AL_05_ProfilesConfiguration_Alarms_CreateProfile_ModeProxy extends SuperHelper implements PropertiesProfilesList {
	...
	@Test (priority = 0)
	public void profilesListCreateProfileModeProxyForAlarms() throws InterruptedException {
		
		classMethodLogger.log(); 
		selectFromDropDown(SLC_ITEMS_PER_PAGE, "50");
		pr.createProfile("Pr01ProxyAlarms", TXT_PROXY, OpenBranchVersion);
		setMethodState();
	}
