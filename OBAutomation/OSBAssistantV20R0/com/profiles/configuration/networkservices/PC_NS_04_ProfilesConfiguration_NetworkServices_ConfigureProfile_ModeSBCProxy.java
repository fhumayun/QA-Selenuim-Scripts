...
public class PC_NS_04_ProfilesConfiguration_NetworkServices_ConfigureProfile_ModeSBCProxy extends SuperHelper implements PropertiesProfilesList,PropertiesAlarms {
	...
	@Test (priority = 0)
	public void profilesConfigureProfileModeSBCProxyForNetworkSevices() throws InterruptedException {
		
		//Configure Network Services for Profile of Mode Branch SBC
		classMethodLogger.log(); 
		selectFromDropDown(SLC_SELECTPROFILE, "Pr04SBCProxyNetworkServices");
		ns.configureProfileForNetworkServices();
	    setMethodState();
	}
	
	@Test (priority = 1)
	public void profilesAssignProfileModeSBCProxyForNetworkSevices() throws InterruptedException {
		
		//Assign the profile to the OpenBranch
		methodLogger.log(); 
		pr.assignProfile("Pr04SBCProxyNetworkServices");
		setMethodState();   
	}
	
	@Test(priority = 2)
	 public void verifyProfileModeSBCProxyForNetworkSevicesAssignment() throws InterruptedException {
