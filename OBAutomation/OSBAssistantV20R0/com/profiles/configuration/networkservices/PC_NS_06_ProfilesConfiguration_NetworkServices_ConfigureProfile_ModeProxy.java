...
public class PC_NS_06_ProfilesConfiguration_NetworkServices_ConfigureProfile_ModeProxy extends SuperHelper implements PropertiesProfilesList,PropertiesAlarms {
	...
	@Test (priority = 0)
	public void profilesConfigureProfileModeProxyForNetworkSevices() throws InterruptedException {
		
		//Configure Network Services for Profile of Mode Branch SBC
		classMethodLogger.log(); 
		selectFromDropDown(SLC_SELECTPROFILE, "Pr04ProxyNetworkServices");
		ns.configureProfileForNetworkServices();
	    setMethodState();
	}
	
	@Test (priority = 1)
	public void profilesAssignProfileModeProxyForNetworkSevices() throws InterruptedException {
		
		//Assign the profile to the OpenBranch
		methodLogger.log(); 
		pr.assignProfile("Pr04ProxyNetworkServices");
		setMethodState();   
	}
	
	@Test(priority = 2)
	 public void verifyProfileModeProxyForNetworkSevicesAssignment() throws InterruptedException {
