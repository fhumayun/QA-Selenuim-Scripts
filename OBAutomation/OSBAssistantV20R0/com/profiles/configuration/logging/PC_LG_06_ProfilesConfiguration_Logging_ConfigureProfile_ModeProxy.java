...
public class PC_LG_06_ProfilesConfiguration_Logging_ConfigureProfile_ModeProxy extends SuperHelper implements PropertiesProfilesList,PropertiesAlarms {
	...
	@Test (priority = 0)
	public void profilesConfigureProfileModeProxyForLogging() throws InterruptedException {
		
		//Configure Logging for Profile of Mode Branch SBC
		classMethodLogger.log(); 
		selectFromDropDown(SLC_SELECTPROFILE, "Pr02ProxyLogging");
		lg.configureProfileForLogging();
	    setMethodState();
	}
	
	@Test (priority = 1)
	public void profilesAssignProfileModeProxyForLogging() throws InterruptedException {
		
		//Assign the profile to the OpenBranch
		methodLogger.log(); 
		pr.assignProfile("Pr02ProxyLogging");
		setMethodState();   
	}
	
	@Test(priority = 2)
	 public void verifyProfileModeProxyForLoggingAssignment() throws InterruptedException {
