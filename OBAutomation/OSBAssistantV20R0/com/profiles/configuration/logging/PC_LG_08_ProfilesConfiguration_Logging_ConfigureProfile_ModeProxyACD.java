...
public class PC_LG_08_ProfilesConfiguration_Logging_ConfigureProfile_ModeProxyACD extends SuperHelper implements PropertiesProfilesList,PropertiesAlarms {
	...
	@Test (priority = 0)
	public void profilesConfigureProfileModeProxyACDForLogging() throws InterruptedException {
		
		//Configure Logging for Profile of Mode Branch SBC
		classMethodLogger.log(); 
		selectFromDropDown(SLC_SELECTPROFILE, "Pr02ProxyACDLogging");
		lg.configureProfileForLogging();
	    setMethodState();
	}
	
	@Test (priority = 1)
	public void profilesAssignProfileModeProxyACDForLogging() throws InterruptedException {
		
		//Assign the profile to the OpenBranch
		methodLogger.log(); 
		pr.assignProfile("Pr02ProxyACDLogging");
		setMethodState();   
	}
	
	@Test(priority = 2)
	 public void verifyProfileModeProxyACDForLoggingAssignment() throws InterruptedException {
