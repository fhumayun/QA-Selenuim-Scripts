...
public class PC_MS_06_ProfilesConfiguration_MediaServer_ConfigureProfile_ModeProxy extends SuperHelper implements PropertiesProfilesList,PropertiesAlarms {
	...
	@Test (priority = 0)
	public void profilesConfigureProfileModeProxyForMediaServer() throws InterruptedException {
		
		//Configure Media Server for Profile of Mode Branch SBC
		classMethodLogger.log(); 
		selectFromDropDown(SLC_SELECTPROFILE, "Pr03ProxyMediaServer");
		ms.configureProfileForMediaServer();
	    setMethodState();
	}
	
	@Test (priority = 1)
	public void profilesAssignProfileModeProxyForMediaServer() throws InterruptedException {
		
		//Assign the profile to the OpenBranch
		methodLogger.log(); 
		pr.assignProfile("Pr03ProxyMediaServer");
		setMethodState();   
	}
	
	@Test(priority = 2)
	 public void verifyProfileModeProxyForMediaServerAssignment() throws InterruptedException {
