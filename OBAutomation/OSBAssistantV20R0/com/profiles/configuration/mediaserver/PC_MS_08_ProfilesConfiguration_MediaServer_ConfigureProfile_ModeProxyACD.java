...
public class PC_MS_08_ProfilesConfiguration_MediaServer_ConfigureProfile_ModeProxyACD extends SuperHelper implements PropertiesProfilesList,PropertiesAlarms {
	...
	@Test (priority = 0)
	public void profilesConfigureProfileModeProxyACDForMediaServer() throws InterruptedException {
		
		//Configure Media Server for Profile of Mode Branch SBC
		classMethodLogger.log(); 
		selectFromDropDown(SLC_SELECTPROFILE, "Pr03ProxyACDMediaServer");
	    ms.configureProfileForMediaServer();
	    setMethodState();
	}
	
	@Test (priority = 1)
	public void profilesAssignProfileModeProxyACDForMediaServer() throws InterruptedException {
		
		//Assign the profile to the OpenBranch
		methodLogger.log(); 
		pr.assignProfile("Pr03ProxyACDMediaServer");
		setMethodState();   
	}
	
	@Test(priority = 2)
	 public void verifyProfileModeProxyACDForMediaServerAssignment() throws InterruptedException {
