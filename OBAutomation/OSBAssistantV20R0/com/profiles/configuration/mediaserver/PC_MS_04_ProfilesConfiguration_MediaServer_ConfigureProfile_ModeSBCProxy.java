...
public class PC_MS_04_ProfilesConfiguration_MediaServer_ConfigureProfile_ModeSBCProxy extends SuperHelper implements PropertiesProfilesList,PropertiesAlarms {
	...
	@Test (priority = 0)
	public void profilesConfigureProfileModeSBCProxyForMediaServer() throws InterruptedException {
		
		//Configure Media Server for Profile of Mode Branch SBC
		classMethodLogger.log(); 
		selectFromDropDown(SLC_SELECTPROFILE, "Pr03SBCProxyMediaServer");
		ms.configureProfileForMediaServer();
	    setMethodState();
	}
	
	@Test (priority = 1)
	public void profilesAssignProfileModeSBCProxyForMediaServer() throws InterruptedException {
		
		//Assign the profile to the OpenBranch
		methodLogger.log(); 
		pr.assignProfile("Pr03SBCProxyMediaServer");
		setMethodState();   
	}
	
	@Test(priority = 2)
	 public void verifyProfileModeSBCProxyForMediaServerAssignment() throws InterruptedException {
