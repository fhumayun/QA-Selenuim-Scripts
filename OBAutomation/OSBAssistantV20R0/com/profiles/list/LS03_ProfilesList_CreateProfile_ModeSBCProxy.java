...
public class LS03_ProfilesList_CreateProfile_ModeSBCProxy extends SuperHelper implements PropertiesProfilesList {
	...
	public Object[][] createDataProduct() {
		return new Object[][] {
				 {"Profile4",TXT_SBC_PROXY,"V1.R4"},
				 {"Profile5",TXT_SBC_PROXY,"V1.R41"},
				 {"Profile6",TXT_SBC_PROXY,"V2.R0"},
		};	
	}
	
	@Test (priority = 0,dataProvider = "ProfileData")
	public void profilesListCreateProfileModeSBCProxy(String x1,String x2,String x3) throws InterruptedException {
		...
		//Create Profile Mode SBC Proxy(input from data Provider)
	...
	public void verifyProfilesListProfileModeSBCProxyFields(String x1,String x2,String x3) throws InterruptedException {
