...
public class LS09_ProfilesList_EditProfile_ModeProxyACD extends SuperHelper implements PropertiesProfilesList {
	...
	public Object[][] createDataProduct() {
		return new Object[][] {
				 {"Profile10","Profile100"},
				 {"Profile20","Profile200"},
				 {"Profile30","Profile300"},
		};	
	}
	
	@Test (priority = 0,dataProvider = "ProfileData")
	public void profilesListModifyProfileModeProxyACD(String x1,String x2) throws InterruptedException {
