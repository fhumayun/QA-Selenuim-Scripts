...
public class JM09_JobManagement_AddScheduledTranferWavFile extends SuperHelper implements PropertiesJobManagement {
	...
	@Test (priority = 0)
	public void jobManagementAddScheduledTranferWavFile() throws InterruptedException {
		
		classMethodLogger.log(); 
		//Add an Scheduled Transfer Wav File
	    clickButtonAdd();
	    updateMap(RETRIES);
		...
		type_byId(IPF_NOTE, "SchTranferWav7");
		...
		String row = getRow(TBL_LIST_JOBS, "SchTranferWav7");
