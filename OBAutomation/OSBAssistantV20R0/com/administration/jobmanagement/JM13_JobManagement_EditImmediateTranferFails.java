...
public class JM13_JobManagement_EditImmediateTranferFails extends SuperHelper implements PropertiesJobManagement {
	...
	@Test (priority = 0)
	public void jobManagementEditImmediateTranferFails() throws InterruptedException {
		...
		type_byId(IPF_NOTE, "EditImJobFails");
		...
		String row = getRow(TBL_LIST_JOBS, "EditImJobFails");
		...
		//Check that the Immediate Job cannot be Edited
		clickCheckbox_byText("EditImJobFails");
		clickButtonEdit();
		updateMap(RETRIES);
		checkMessageFailed("OpenBranch\\OpenBranchGuiError", "edit.immediateSchedule", null);
		updateMap(RETRIES);
