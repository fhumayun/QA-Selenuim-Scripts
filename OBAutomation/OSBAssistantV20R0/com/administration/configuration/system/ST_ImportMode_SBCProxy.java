...
public class ST_ImportMode_SBCProxy extends SuperHelper implements PropertiesVoip {
	...
	@Test (priority = 0)
	public void importModeSBCProxy() throws InterruptedException {
		
		classMethodLogger.log(); 
        importXMLFile("C:\\OB_XmlFiles\\OB2LAN-SBCProxy-config.xml");
