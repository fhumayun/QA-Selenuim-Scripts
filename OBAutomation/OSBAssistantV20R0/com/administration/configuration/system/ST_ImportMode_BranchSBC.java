...
public class ST_ImportMode_BranchSBC extends SuperHelper implements PropertiesVoip {
	...
	@Test (priority = 0)
	public void importModeBranchSBC() throws InterruptedException {
		
		classMethodLogger.log(); 
		importXMLFile("C:\\OB_XmlFiles\\OB2LAN-BranchSBC-config.xml");
